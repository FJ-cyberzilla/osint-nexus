import pytest
from osint_nexus.core.confidence import ConfidenceEngine, ConfidenceResult
...
def test_confidence_with_multipliers_and_bonuses():
    ...
    result = engine.calculate_confidence(
        ["linkedin", "github"],
        multipliers={"dormant": 0.8},
        additive_bonuses={"device_match": 25.0}
    )

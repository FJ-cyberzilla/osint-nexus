...
class HealthTracker:
    ...
    def __init__(self, failure_threshold: int = 5, default_recovery_timeout: float = 60.0) -> None:
        """
        Initializes the HealthTracker.

        Args:
            failure_threshold: Number of consecutive failures before marking as FAILED.
            default_recovery_timeout: Time in seconds to wait before attempting recovery.
        """
    ...
    def set_provider_timeout(self, provider_name: str, timeout: float) -> None:
        ...
        Args:
            ...
            timeout: The recovery timeout in seconds.
        """
    ...
    def is_healthy(self, provider_name: str) -> bool:
        ...
        Returns:
            True if healthy, False if it should be skipped.
        """
    ...
    def should_attempt_recovery(self, provider_name: str) -> bool:
        ...
        Returns:
            True if it's time to attempt recovery, False otherwise.
        """
    ...
    def reset(self, provider_name: str | None = None) -> None:
        """
        Resets failure data for a specific provider, or all if none specified.

        Args:
            provider_name: The name of the provider, or None to reset all.
        """
        if provider_name:

...
- **System Metrics:** Real-time visibility into Device Type, TLS Fingerprint, Telemetry status, and Heatmap generation.
...
- **Active Status Reporting:** Dynamic status bar providing granular details on the current engine action.
...
The TUI includes a priority-based alert system for real-time engine health monitoring:

| Alert Level | Color | Purpose |
| :--- | :--- | :--- |
| **SYSTEM ALERTS** | Yellow | Critical reconnaissance or network failures. |
